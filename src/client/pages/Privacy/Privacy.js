                ...
                <div className={styles.container}>
                    ...
                    <div className={styles.data}>
                        ...
                        <ol>
                            ...
                            <li> Актуальная версия Политики в свободном доступе расположена в сети Интернет по адресу <a href='/politika_konfidencialnosty'>https://brus-bany.ru/politika_konfidencialnosty</a>. </li>
                        </ol>
                    </div>
                </div>
            </Page>
