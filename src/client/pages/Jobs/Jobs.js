...
const META = {
    ...
    description: '🏠 В строительную компанию Брус бани в связи с ростом объемов работ требуется бригада на строительство бань из 3 человек 📳 8(800)201-07-29'
};
        ...
        <Page breadcrumbs={breadcrumbs}>
            ...
            <div className={styles.container}>
                ...
                <Text className={styles.data}>
                    В строительную компанию Брус бани в связи с ростом объемов работ требуется бригада на строительство бань из 3 человек. Основное направление - частное строительство бань и домов.
                </Text>
                {items.map(item => (
