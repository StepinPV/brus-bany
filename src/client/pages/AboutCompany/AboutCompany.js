...
const article = {
    content: [{
        content: [{
            ...
            item: {
                typeId: 'text',
                value: 'Мы не гонимся за количеством построенных объектов, мы хотим, чтобы наши клиенты стали счастливее. Мы искренне радуемся, когда нам оставляют <a href="/otzyvy" style="color: #ff8562; text-decoration: none">позитивные отзывы</a>, это не просто слова, нам действительно это важно.'
            }
        }, {
            item: {
                typeId: 'text',
