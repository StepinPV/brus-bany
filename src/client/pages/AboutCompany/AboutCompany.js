...
const article = {
    content: [{
        content: [{
            item: {
                typeId: 'text',
                value: 'Компания "Брус бани" <a href="/rekvizity" style="color: #963113; text-decoration: none">основана</a> в 2009 году в Новгородской области г.Пестово.\n' +
                    'С момента основания компании мы построили около 1000 объектов бань, некоторые проекты можно посмотреть в разделе <a href="/photos" style="color: #963113; text-decoration: none">"Фотоотчеты построенных объектов"</a>.'
            }
        }, {
            item: {
                typeId: 'text',
