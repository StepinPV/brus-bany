    ...
    const renderPreview = () => {
        return (
            <div ref={ref => { containerRef = ref; }}>
                ...
                {formValue.mode ==='dogovor1' ? renderDogovor1(project, formValue, data, finalPrice, projectName) : null}
                {formValue.mode ==='dogovor2' ? renderDogovor2(project, formValue, data, finalPrice, projectName) : null}
