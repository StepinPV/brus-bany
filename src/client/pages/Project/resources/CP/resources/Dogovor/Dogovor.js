...
const pravila = () => {
    return (
        <>
            ...
            <div style={{ textAlign: 'justify' }}>
                1. Данный пункт относится к сооружениям, выполненным из бруса естественной влажности.
                Вследствие использования в строительстве стенового материала атмосферной сушки, внутри
